...
add_filter( 'line/iconpicker_params', function( $params ) {
	$params[] = array(
		'type'        => 'iconpicker',
		'heading'     => esc_html__( 'Icon', 'glb' ),
		'param_name'  => 'icon_etline',
		'value'       => '', // default value to backend editor admin_label
		'description' => esc_html__( 'Select icon from library.', 'glb' ),
		'settings'    => array(
			'emptyIcon'    => false,
			'type'         => 'etline',
			'iconsPerPage' => 4000
...
add_filter( 'line/iconpicker_types_dropdown', function( $types ) {
	$types[esc_html__( 'Elegent Theme LineIcons', 'glb' )] = 'etline';
	$types[esc_html__( 'Simple Line Icons', 'glb' )] = 'simpleline';
...
// 	switch ( $font ) {
// 		case 'etline':
// 			wp_enqueue_style( 'et-line-font', get_template_directory_uri() . '/assets/icons/et-line-font/style.css' );
// 		break;

// 		case 'simpleline':
// 			wp_enqueue_style( 'simple-line-icons', get_template_directory_uri() . '/assets/icons/simple-line-icons/css/simple-line-icons.css' );
// 		break;
// 	}
// } );
