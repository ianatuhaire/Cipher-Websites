 ...
 * @return  void
 */
function glb__define_style( $selector, array $attributes ) {
...
function glb__scheme_styles() {
	global $wp_filesystem;
	
	if ( glb__initialize_filesystem_api() ) {
		$content = $wp_filesystem->get_contents( GLB__PATH . 'assets/less/_color.less' );
		$colors  = glb__option( 'global__typography__scheme' );
 ...
 * @return  array
 */
function glb__typography_styles( array $options ) {
	$styles = array();

	if ( isset( $options['family'] ) && $family = glb__parse_font( $options['family'] ) ) {
...
function glb__parse_font( $font, $enqueue = true ) {
 ...
 * @return  array
 */
function glb__background_styles( $options ) {
	$styles = array();
 ...
 * @return  array
 */
function glb__border_styles( $options ) {
 ...
 * @return  string
 */
function glb__color_to_rgba( $color, $alpha ) {
