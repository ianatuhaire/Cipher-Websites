 ...
 */
class Glb__Options_Background extends Glb__Options_Control
{
	/**
	 * The control type
	 * 
	...
	public function render_content() {
		...
		?>
			...
			<label class="button" for="<?php echo esc_attr( $name ) ?>-toggler"><?php _ex( 'Edit Background Settings', 'options', 'glb' ) ?></label>
