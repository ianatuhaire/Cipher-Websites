...
<script id="tmpl-sd-installer" type="text/x-template">
	<div id="sd-installer" class="sd-installer wrap about-wrap">
		<h1><?php esc_html_e( 'Sample Data Installation', 'glb' ) ?></h1>
		<p class="sd-description about-description">
			<?php esc_html_e( 'Importing demo data (post, pages, images, theme settings, ...) is the easiest way to setup your theme.	It will allow you to quickly edit everything instead of creating content from scratch.', 'glb' ) ?>
		</p>
